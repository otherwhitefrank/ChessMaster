...
function drawPiecesOnBoard() {
    ...
    var whiteRook1 = new Piece('a', '8', '/assets/chess_pieces/Chess_symbols_r2_c3.png', 'white');
    pieces.push(whiteRook1);

    var whiteRook2 = new Piece('h', '8', '/assets/chess_pieces/Chess_symbols_r2_c3.png', 'white');
    pieces.push(whiteRook2);


    //Draw white knight 1 and 2
    var whiteKnight1 = new Piece('b', '8', '/assets/chess_pieces/Chess_symbols_r2_c4.png', 'white');
    pieces.push(whiteKnight1);

    var whiteKnight2 = new Piece('g', '8', '/assets/chess_pieces/Chess_symbols_r2_c4.png', 'white');
    pieces.push(whiteKnight2);


    //Draw white bishop 1 and 2
    var whiteBishop1 = new Piece('c', '8', '/assets/chess_pieces/Chess_symbols_r2_c5.png', 'white');
    pieces.push(whiteBishop1);

    var whiteBishop2 = new Piece('f', '8', '/assets/chess_pieces/Chess_symbols_r2_c5.png', 'white');
    pieces.push(whiteBishop2);

    //Draw white king
    var whiteKing = new Piece('e', '8', '/assets/chess_pieces/Chess_symbols_r2_c1.png', 'white');
    pieces.push(whiteKing);

    //Draw white queen
    var whiteQueen = new Piece('d', '8', '/assets/chess_pieces/Chess_symbols_r2_c2.png', 'white');
    pieces.push(whiteQueen);

    //Draw white pawns
    var whitePawn1 = new Piece('a', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn1);
    var whitePawn2 = new Piece('b', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn2);
    var whitePawn3 = new Piece('c', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn3);
    var whitePawn4 = new Piece('d', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn4);
    var whitePawn5 = new Piece('e', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn5);
    var whitePawn6 = new Piece('f', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn6);
    var whitePawn7 = new Piece('g', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn7);
    var whitePawn8 = new Piece('h', '7', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    ...
    var blackRook1 = new Piece('a', '1', '/assets/chess_pieces/Chess_symbols_r1_c3.png', 'black');
    pieces.push(blackRook1);

    var blackRook2 = new Piece('h', '1', '/assets/chess_pieces/Chess_symbols_r1_c3.png', 'black');
    pieces.push(blackRook2);


    //Draw black knight 1 and 2
    var blackKnight1 = new Piece('b', '1', '/assets/chess_pieces/Chess_symbols_r1_c4.png', 'black');
    pieces.push(blackKnight1);

    var blackKnight2 = new Piece('g', '1', '/assets/chess_pieces/Chess_symbols_r1_c4.png', 'black');
    pieces.push(blackKnight2);


    //Draw black bishop 1 and 2
    var blackBishop1 = new Piece('c', '1', '/assets/chess_pieces/Chess_symbols_r1_c5.png', 'black');
    pieces.push(blackBishop1);

    var blackBishop2 = new Piece('f', '1', '/assets/chess_pieces/Chess_symbols_r1_c5.png', 'black');
    pieces.push(blackBishop2);

    //Draw black king
    var blackKing = new Piece('e', '1', '/assets/chess_pieces/Chess_symbols_r1_c1.png', 'black');
    pieces.push(blackKing);

    //Draw black queen
    var blackQueen = new Piece('d', '1', '/assets/chess_pieces/Chess_symbols_r1_c2.png', 'black');
    pieces.push(blackQueen);

    //Draw black pawns
    var blackPawn1 = new Piece('a', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn1);
    var blackPawn2 = new Piece('b', '2', '/assets//chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn2);
    var blackPawn3 = new Piece('c', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn3);
    var blackPawn4 = new Piece('d', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn4);
    var blackPawn5 = new Piece('e', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn5);
    var blackPawn6 = new Piece('f', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn6);
    var blackPawn7 = new Piece('g', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn7);
    var blackPawn8 = new Piece('h', '2', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
