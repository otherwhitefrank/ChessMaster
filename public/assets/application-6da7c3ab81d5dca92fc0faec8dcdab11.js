...
(function() {
  var bind_events, join_game, root, unbind_events;

  $(document).ready(function() {
    root.pusher = new Pusher('bca91b4571f77551a885');
    root.wait_room = pusher.subscribe('wait_room');
    root.player_1_id = void 0;
    root.player_2_id = void 0;
    root.unique_channel_id = void 0;
    root.game_room = {};
    ...
    if (player_2_id !== void 0) {
      bind_events(unique_channel_id);
    }
    wait_room.bind('server:join_channel', function(data) {
      if (data.active_player_id.toString() === player_1_id) {
        ...
        return join_game(player_1_id, player_2_id, unique_channel_id);
      }
    });
    wait_room.bind('server:leave_channel', function(data) {
    ...
    return $('#message').keypress(function(e) {
      if (e.keyCode === 13) {
        e.preventDefault();
        return $.ajax('/broadcast/broadcast', {
          type: 'POST',
          data: {
            message: $("#message").val(),
            event: 'user:said',
  ...
  root.send_message = function(event_type, message) {
    return $.ajax('/broadcast/broadcast', {
      type: 'POST',
      data: {
        message: message,
      ...
      error: function(jqXHR, textStatus, errorThrown) {
        return console.log("AJAX Error: " + textStatus + "<br>");
      },
      success: function(data, textStatus, jqXHR) {
        return console.log("Successful AJAX call: " + data + "<br>");
      }
    });
  };

  bind_events = function(channel_id) {
    window.game_room = window.pusher.subscribe(channel_id);
    window.game_room.bind('server:said', function(data) {
      return $('#message-area').append("" + data.message + "<br>");
    });
    window.game_room.bind('server:move_ok', function(data) {
      if (data.user_id === root.player_1_id) {
        return window.ok_to_move(data);
      }
    });
    window.game_room.bind('server:move_not_ok', function(data) {
      if (data.user_id === root.player_1_id) {
        return window.bad_move(data);
      }
    });
    return window.game_room.bind('server:delete_piece', function(data) {
      if (data.user_id === root.player_1_id) {
        return window.delete_piece(data);
      }
    });
  };

  unbind_events = function(channel_id) {
    return window.game_room = window.pusher.unsubscribe(data.channel_id);
  };

  join_game = function(player_1_id, player_2_id, unique_channel_id) {
    $('#active_user_id').val(player_1_id.toString());
    $('#opponent_user_id').val(player_2_id.toString());
    $('#unique_channel_id').val(unique_channel_id);
    return $('#join_game_id').submit();
  };
...
function drawPiecesOnBoard() {
    ...
    var whiteRook1 = new Piece('a', '1', '/assets/chess_pieces/Chess_symbols_r2_c3.png', 'white');
    pieces.push(whiteRook1);

    var whiteRook2 = new Piece('h', '1', '/assets/chess_pieces/Chess_symbols_r2_c3.png', 'white');
    pieces.push(whiteRook2);


    //Draw white knight 1 and 2
    var whiteKnight1 = new Piece('b', '1', '/assets/chess_pieces/Chess_symbols_r2_c4.png', 'white');
    pieces.push(whiteKnight1);

    var whiteKnight2 = new Piece('g', '1', '/assets/chess_pieces/Chess_symbols_r2_c4.png', 'white');
    pieces.push(whiteKnight2);


    //Draw white bishop 1 and 2
    var whiteBishop1 = new Piece('c', '1', '/assets/chess_pieces/Chess_symbols_r2_c5.png', 'white');
    pieces.push(whiteBishop1);

    var whiteBishop2 = new Piece('f', '1', '/assets/chess_pieces/Chess_symbols_r2_c5.png', 'white');
    pieces.push(whiteBishop2);

    //Draw white king
    var whiteKing = new Piece('e', '1', '/assets/chess_pieces/Chess_symbols_r2_c1.png', 'white');
    pieces.push(whiteKing);

    //Draw white queen
    var whiteQueen = new Piece('d', '1', '/assets/chess_pieces/Chess_symbols_r2_c2.png', 'white');
    pieces.push(whiteQueen);

    //Draw white pawns
    var whitePawn1 = new Piece('a', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn1)
    var whitePawn2 = new Piece('b', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn2);
    var whitePawn3 = new Piece('c', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn3);
    var whitePawn4 = new Piece('d', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn4);
    var whitePawn5 = new Piece('e', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn5);
    var whitePawn6 = new Piece('f', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn6);
    var whitePawn7 = new Piece('g', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    pieces.push(whitePawn7);
    var whitePawn8 = new Piece('h', '2', '/assets/chess_pieces/Chess_symbols_r2_c6.png', 'white');
    ...
    var blackRook1 = new Piece('a', '8', '/assets/chess_pieces/Chess_symbols_r1_c3.png', 'black');
    pieces.push(blackRook1);

    var blackRook2 = new Piece('h', '8', '/assets/chess_pieces/Chess_symbols_r1_c3.png', 'black');
    pieces.push(blackRook2);


    //Draw black knight 1 and 2
    var blackKnight1 = new Piece('b', '8', '/assets/chess_pieces/Chess_symbols_r1_c4.png', 'black');
    pieces.push(blackKnight1);

    var blackKnight2 = new Piece('g', '8', '/assets/chess_pieces/Chess_symbols_r1_c4.png', 'black');
    pieces.push(blackKnight2);


    //Draw black bishop 1 and 2
    var blackBishop1 = new Piece('c', '8', '/assets/chess_pieces/Chess_symbols_r1_c5.png', 'black');
    pieces.push(blackBishop1);

    var blackBishop2 = new Piece('f', '8', '/assets/chess_pieces/Chess_symbols_r1_c5.png', 'black');
    pieces.push(blackBishop2);

    //Draw black king
    var blackKing = new Piece('e', '8', '/assets/chess_pieces/Chess_symbols_r1_c1.png', 'black');
    pieces.push(blackKing);

    //Draw black queen
    var blackQueen = new Piece('d', '8', '/assets/chess_pieces/Chess_symbols_r1_c2.png', 'black');
    pieces.push(blackQueen);

    //Draw black pawns
    var blackPawn1 = new Piece('a', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn1);
    var blackPawn2 = new Piece('b', '7', '/assets//chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn2);
    var blackPawn3 = new Piece('c', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn3);
    var blackPawn4 = new Piece('d', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn4);
    var blackPawn5 = new Piece('e', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn5);
    var blackPawn6 = new Piece('f', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn6);
    var blackPawn7 = new Piece('g', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
    pieces.push(blackPawn7);
    var blackPawn8 = new Piece('h', '7', '/assets/chess_pieces/Chess_symbols_r1_c6.png', 'black');
